...
import (
	...
	"github.com/BelyaevEI/news-parser/internal/publisher/economist/ecorepository"
...
// Parse article economist.com and post to telegram channel
func (s *Service) RunEconomist() {
	for {
...
func (s *Service) getNewArticles() (model.Article, error) {
	...
	// Get article
	article, err := ecorepository.GetArticle()
