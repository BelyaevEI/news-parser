...
import (
	...
	"github.com/BelyaevEI/news-parser/internal/publisher/nyt/nytrepository"
...
// Parse article nyt.com and post to telegram channel
func (s *Service) RunNewYorkTimes() {
	for {
...
func (s *Service) getNewArticles() (model.Article, error) {
	...
	// Get article
	article, err := nytrepository.GetArticle()
